...
- (void)buildUI {
    ...
    NSString *appVer = [NSBundle mainBundle].infoDictionary[@"CFBundleShortVersionString"] ?: @"1.3.7";
...
- (void)checkForUpdate {
    ...
    NSURLSessionDataTask *task = [[NSURLSession sharedSession] dataTaskWithURL:url
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            NSString *current = [NSBundle mainBundle].infoDictionary[@"CFBundleShortVersionString"] ?: @"1.3.7";
...
- (void)showAppInfo {
    ...
    NSString *ver    = info[@"CFBundleShortVersionString"] ?: @"1.3.7";
